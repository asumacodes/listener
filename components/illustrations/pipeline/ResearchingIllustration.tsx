  ...
  if (desktop) {
    return (
      <IllustrationFrame ariaLabel="Researching the market" {...props}>
        ...
        />
        <line
          className="ill-draw ill-soft"
          pathLength={1}
          style={{ ...delay(2.4), opacity: 0.75 }}
          x1="28"
          y1="86"
          x2="44"
          y2="58"
        ...
        <circle
          className="ill-pulse"
          style={{ ...delay(2.8), opacity: 0.8 }}
          cx="28"
          cy="86"
          r="3.4"
        />
        <circle
          className="ill-pulse ill-fill-warm"
          style={{ ...delay(3), opacity: 0.7 }}
          cx="66"
          cy="30"
          r="3.2"
        />
