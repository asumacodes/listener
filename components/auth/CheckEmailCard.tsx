...
const CheckEmailCard = ({
  ...
  return (
    <div className="animate-fade-in w-full rounded-2xl border border-border bg-white px-5 py-6 shadow-sm">
      <div className="flex items-start gap-3">
        <span className="mt-0.5 text-gold">
          <MailIcon className="h-5 w-5" />
        </span>
        <div className="min-w-0 flex-1">
          <h2 className="text-base font-medium text-text">Check your email</h2>
          ...
          <p className="mt-4 text-xs text-muted">
            ...
            <button
              ...
              className="font-medium text-gold underline underline-offset-2 disabled:opacity-50"
            >
