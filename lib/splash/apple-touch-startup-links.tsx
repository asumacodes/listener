// KAN-38 item 1: iOS apple-touch-startup-image links (pwa-asset-generator).
// hrefs corrected to /splash/* — generator --path flag doubled the folder prefix.

export const AppleTouchStartupLinks = () => (
  <>
    <link
